    ...
    items: [
      {
        ...
        description:
          "Olive Tree Media is a licensed SMS & Bulk Messaging Solutions and Content Services Provider.",
        buttonLable: "Live",
        buttonLink: "https://olivetreehub.com/",
      },
      {
        id: 2,
        ...
        description:
          "Elewa website redesign uses Angular Universal to render while integrating webflow CMS blog posts",
        buttonLable: "Live",
      ...
      },
      {
        ...
        title: "Pharmacorp",
        description:
          "Website that connect sale-reps to pharmaceutical agencies. and also connect doctors to patients",
        buttonLable: "Live",
    ...
    items: [
      {
        ...
        description:
          "Tweety is an application where user can create account post and react on tweets.",
        buttonLable: "Github",
      ...
      },
      {
        ...
        title: "Neighbourhood",
        description:
          "Allows user to join a hood owned by admin, and can see posts in only that hood.",
        buttonLable: "Github",
